...
class HistoryAdapter(private val userId : String, private val dataList : ArrayList<HistoryDataModel>, private val listener: RecyclerViewItemClickListener) : RecyclerView.Adapter<HistoryAdapter.ViewHolder>() {
